...
def calculateGainDict(data_characterization,label="booster",calculateRipple=False):
    ...
    for metadata in data_characterization:
        ...
        # delta 1 - calibration with total power and spectrum sum power
        ...
        # delta 2 - calibration with total power and spectrum sum power
...
def plotGainData(indxForFigure,dataDict,title,
...
def plotGainDataNormalize(indxForFigure,dataDict,title,
        saveName=None,scatterColor="blue",alphaNum=0.2,
        gridLine=True,makerSize=2):
    plt.figure(indxForFigure)
    x_axises, y_data = recoverDict(dataDict)
...
def plotGainDataInWavelength(indxForFigure,dataDict,title,
        saveName=None,scatterColor="blue",alphaNum=0.2,
        gridLine=True,makerSize=2):
    plt.figure(indxForFigure)
    x_axises, y_data = recoverDict(dataDict)
